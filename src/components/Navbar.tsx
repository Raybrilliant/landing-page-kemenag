...
export default function Navbar() {
  ...
  const ppid = [
    ...
    { title: "Informasi Publik", href:"#", links: [
      { href: "/informasi-publik/berkala", label: "Informasi Berkala" },
      { href: "/informasi-publik/serta-merta", label: "Informasi Serta Merta" },
      { href: "/informasi-publik/tersedia-setiap-saat", label: "Informasi Tersedia Setiap Saat" },
      { href: "/informasi-publik/dikecualikan", label: "Informasi Dikecualikan" },
      { href: "/informasi-publik/sop-pelayanan", label: "SOP Pelayanan" },
      { href: "/informasi-publik/sp-sop-ptsp", label: "SP & SOP PTSP" },
      { href: "/informasi-publik/laporan-kinerja", label: "Laporan Kinerja" },
      { href: "/informasi-publik/laporan-keuangan-bmn", label: "Laporan Keuangan dan BMN" },
      { href: "/informasi-publik/laporan-dipa", label: "Laporan DIPA" },
      { href: "/informasi-publik/laporan-realisasi-anggaran", label: "Laporan Realisasi Anggaran" },
      { href: "/informasi-publik/lhkpn", label: "LHKPN" },
    ]},
    { title: "Regulasi", href:"/regulasi", links:[], },
    { title: "Layanan Informasi", href:"#", links:[
      { href: "/layanan-informasi/tata-cara-permohonan-informasi", label: "Tata Cara Permohonan Informasi" },
      { href: "/layanan-informasi/tata-cara-sengketa-informasi", label: "Tata Cara Sengketa Informasi" },
      { href: "/layanan-informasi/tata-cara-pengaduan-masyarakat", label: "Tata Cara Pengaduan Masyarakat" },
      { href: "/layanan-informasi/tata-cara-pengajuan-keberatan", label: "Tata Cara Pengajuan Keberatan" },
      { href: "/layanan-informasi/alasan-pengajuan-keberatan", label: "Alasan Pengajuan Keberatan" },
      { href: "/layanan-informasi/sop-layanan-informasi-publik", label: "SOP Layanan Informasi Publik" },
      { href: "/layanan-informasi/standar-pengumuman-informasi", label: "Standar Pengumuman Informasi" },
    ]},
    { title: "Standar Layanan", href:"#", links:[
      { href: "/standar-layanan/maklumat-pelayanan", label: "Maklumat Pelayanan" },
      { href: "/standar-layanan/jadwal-pelayanan", label: "Jadwal Pelayanan" },
      { href: "/standar-layanan/biaya-tarif-layanan", label: "Biaya/Tarif Layanan" },
      { href: "/standar-layanan/standar-pelayanan", label: "Standar Pelayanan" },
      { href: "/standar-layanan/arah-kebijakan-layanan", label: "Arah Kebijakan Layanan" },
      { href: "/standar-layanan/strategi-metode-ppem", label: "Strategi dan Metode PPEM" },
    ]},
